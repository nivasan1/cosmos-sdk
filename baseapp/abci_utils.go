...
func validateExtendedCommitAgainstLastCommit(ctx sdk.Context, ec abci.ExtendedCommitInfo, lc comet.CommitInfo) error {
	...
	for i, vote := range ec.Votes {
		...
		ctx.Logger().Info("verifying vote against last-commit", "ec address", vote.Validator.Address, "ec power", vote.Validator.Power, "lc addres", lc.Votes[i].Validator.Address, "lc power", lc.Votes[i].Validator.Power)
	}
